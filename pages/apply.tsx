            ...
            >
              <div style={{ alignItems: "center", justifyContent: "center" }}>
                <img
                  ...
                  src="https://user-images.githubusercontent.com/28320272/207928099-378b6e30-fb3d-4517-9ada-ebc7675742f0.png"
                />
                <p className={styles.successText} style={{}}>
                  Thank you for submitting this form! <br /> We will respond to
                  you within{" "}
            ...
            <div className={styles.graphicContainer}>
              <div className={styles.imageContainer}>
                ...
                >
                  {" "}
                  <img
                    className={styles.imageGraphic}
                    src="https://user-images.githubusercontent.com/28320272/206462622-c35f7a1f-6472-4358-afb4-00849760977c.png"
                  />
                </a>
              </div>
            </div>
            <div
              className={U.classNames(styles.group, rstyles.block)}
              style={{ gridColumn: "span 2/5" }}
            >
              <div className={styles.eventInformation}>
                <h1 className={styles.mainHeading}>Request an Invitation</h1>

                <div
                  className={styles.eventDetailsGrid}
                ...
                <p
                  className={styles.eventInformationCaption}
                  style={{ fontSize: "16px", fontFamily: "Mono" }}
                >
                  {" "}
                  Please fill out this form to apply to be invited. You will
                  receive confirmation within 48 hours if your application has
                  been accepted.
                </p>
                ...
                <div className={styles.title}>
                  Tell us about yourself and why you are interested in joining
                  the party
                </div>
                <Textarea
                  style={{ marginTop: 8 }}
